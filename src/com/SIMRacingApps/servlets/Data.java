...
//                    ip += "\n" + current + " = http://" + current_addr.getHostAddress();
//            }
//        }
//        ip = ip.substring(1);
...
//This bean query only worked with Tomcat. I'm going to rely on using the embedded version and get the port from the main() for now.            
